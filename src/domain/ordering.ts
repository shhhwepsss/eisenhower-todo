 ...
 */
export const rankBetween = ({ before, after }: Neighbours): string => {
...
export const sortByRank = (tasks: readonly Task[]): Task[] => {
 ...
 */
export const endOf = (tasks: readonly Task[]): Neighbours => {
