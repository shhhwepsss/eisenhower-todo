/**
 * Логирование приложения (CLAUDE.md §8).
 *
 ...
 */
function write(level: LogLevel, scope: string, message: string, payload?: LogPayload): void {
 ...
 */
export function createLog(scope: string): Logger {
  return {
